...
export const projects = [
  ...
  },
  {
    ...
    media: [
      { src: "/videos/visionds/vds-overview.mp4", poster: "/videos/visionds/vds-overview-poster.jpg", caption: "Docs platform tour" },
      { src: "/videos/visionds/vds-tokens.mp4", poster: "/videos/visionds/vds-tokens-poster.jpg", caption: "Design token scales" },
      { src: "/videos/visionds/vds-components.mp4", poster: "/videos/visionds/vds-components-poster.jpg", caption: "Interactive components" },
      { src: "/videos/visionds/vds-motion.mp4", poster: "/videos/visionds/vds-motion-poster.jpg", caption: "Motion foundations" },
      { src: "/videos/visionds/vds-data.mp4", poster: "/videos/visionds/vds-data-poster.jpg", caption: "Charts & data display" },
      { src: "/videos/visionds/vds-overlays.mp4", poster: "/videos/visionds/vds-overlays-poster.jpg", caption: "Dialogs & datepicker" },
    ],
  },
  {
    slug: "protocue",
